          ...
          <div v-if="assistants.length === 0" class="text-center py-12">
            ...
            <div class="mt-6">
              ...
              >
                ...
                <span v-if="subscriptionInfo && subscriptionInfo.subscriptionStatus === 'pending' && !isSuperAdmin">Payment Processing</span>
                <span v-else-if="subscriptionInfo && !subscriptionInfo.hasSubscription && !isSuperAdmin">Subscribe to Create</span>
                <span v-else>Create Assistant</span>
              </button>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    async loadSubscriptionInfo() {
      try {
        // Don't load subscription info for super admin users only
