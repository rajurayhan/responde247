                ...
                <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                  ...
                  <div class="flex items-center space-x-2">
                    <button 
                      ...
                      class="inline-flex items-center p-2 text-green-600 hover:text-green-700 hover:bg-green-50 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                      title="View details"
                    >
  ...
  setup() {
    ...
    const fetchResellers = async (page = 1, search = '') => {
      ...
      try {
        ...
        if (search) {
          url = `/api/admin/resellers/search?q=${encodeURIComponent(search)}&page=${page}`
        }
