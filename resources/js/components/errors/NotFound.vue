        ...
        <div class="mt-8 flex justify-center">
          <div class="relative">
            ...
            <div class="absolute -top-2 -right-2 h-8 w-8 bg-red-500 rounded-full flex items-center justify-center">
              <span class="text-white text-sm font-bold">404</span>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-6">
          ...
          <div>
            ...
            <div class="grid grid-cols-1 gap-2">
              <router-link 
                to="/pricing" 
                class="flex items-center px-3 py-2 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-md"
              >
...
export default {
  ...
  created() {
    ...
    document.title = `404 - Page Not Found | ${this.branding.appName}`
  }
}
</script> 